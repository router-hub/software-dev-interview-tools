...
**Question:** Toggle ith bit (0→1, 1→0).
...
// Example: n = 18 (10010)
// n - 1 = 17 (10001)
// 18 & 17 = 10010 & 10001 = 10000 ‰  0 → false
// Time: O(1), Space: O(1)
```
...
**Logic:** Pattern repeats every 4 numbers: n%4 = 0→n, 1→1, 2→n+1, 3→0.
...
**Intuition:** n elements → 2^n subsets. Each subset corresponds to a binary number from 0 to 2^n - 1. Bit position represents element inclusion.
