...
**Intuition:** Recursively check: (1) both null → true, (2) one null → false, (3) values match AND left identical AND right identical.
...
**Logic:** O(log²n) solution by checking if subtrees are perfect.
**Java:**
```java
